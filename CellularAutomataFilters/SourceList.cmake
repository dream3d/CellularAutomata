...
set(_filterGroupName CellularAutomataFilters)
...
foreach(f ${_PublicFilters} )
  ADD_SIMPL_FILTER(  "CellularAutomata" "CellularAutomata"
                        ${_filterGroupName} ${f}
                        ${CellularAutomata_SOURCE_DIR}/Documentation/${_filterGroupName}/${f}.md TRUE ${CellularAutomata_BINARY_DIR})
endforeach()
...
SIMPL_END_FILTER_GROUP(${CellularAutomata_BINARY_DIR} "${_filterGroupName}" "CellularAutomata")
